...
/** 根据 id 获取图片 - 管理员 GET /api/picture/get */
...
/** 根据 id 获取封装的图片 GET /api/picture/get/vo */
...
/** 分页获取封装的图片列表 POST /api/picture/list/page/vo */
...
/** 获取图片标签和分类 GET /api/picture/tag_category */
...
/** 上传图片通过 URL POST /api/picture/upload/url */
